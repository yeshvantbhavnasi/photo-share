  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-black flex">
        ...
        {/* Right sidebar - Edit panel (or simple view panel for readOnly) */}
        <div className={`${readOnly ? 'w-64' : 'w-80'} bg-gray-900 border-l border-gray-800 flex flex-col overflow-hidden`}>
          {/* Panel header */}
          <div className="px-4 py-3 border-b border-gray-800">
            <h2 className="text-lg font-semibold text-white">{readOnly ? 'Photo' : 'Edit Photo'}</h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">
                {readOnly ? 'Actions' : 'Quick Actions'}
              </h3>
              {readOnly ? (
                <button
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Download Photo</span>
                </button>
              ) : (
            ...
            {/* Photo info for readOnly */}
            {readOnly && currentPhoto.filename && (
              <div className="p-3 bg-gray-800 rounded-lg">
                <p className="text-xs text-gray-400 mb-1">Filename</p>
                <p className="text-sm text-gray-200 truncate">{currentPhoto.filename}</p>
              </div>
            )}
          </div>
        </div>
